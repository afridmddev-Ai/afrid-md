...
🤖 **AI Engineer** | RAG Systems · LLM Agents · Generative AI  
📍 Charlotte, NC &nbsp;|&nbsp; 4+ years building production AI systems  
📧 afrid.md.dev@gmail.com

---

## 🔧 What I Build

- 🧠 **RAG Pipelines** — Hybrid retrieval (vector + keyword + metadata) with Pinecone, FAISS, pgvector
- 🤖 **Multi-Agent Systems** — LangGraph, CrewAI, LangChain orchestration at scale
- ⚙️ **LLMOps** — Model routing, hallucination detection, guardrails, LLM-as-Judge evaluations
- ☁️ **Cloud-Native AI** — Docker, AWS (SageMaker, Bedrock, ECS), Azure, CI/CD pipelines
